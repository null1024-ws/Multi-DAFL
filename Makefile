...
afl-fuzz: afl-fuzz.c ./kde/kde.cpp ./kde/interface.cpp types.c $(COMM_HDR) | test_x86
	$(CXX) -c $(CXXFLAGS) ./kde/kde.cpp -o kde.o
	$(CXX) -c $(CXXFLAGS) ./kde/interface.cpp -o interface.o
	$(CC) -c $(CFLAGS) $@.c -o $@.o $(LDFLAGS)
	$(CC) -c $(CFLAGS) types.c -o types.o $(LDFLAGS)
	$(CXX) $(CFLAGS) -o $@ $@.o interface.o kde.o types.o  $(LDFLAGS)
